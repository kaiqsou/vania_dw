...
namespace SistemaAcademico.Controllers
{
    public class MatriculasController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var matriculas = _context.Matriculas.Include(m => m.Aluno).ThenInclude(m => m.Usuario).Include(m => m.Curso);
        ...
        public async Task<IActionResult> Create([Bind("MatriculaId,Data,IdCurso,IdAluno")] Matricula matricula)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MatriculaId,Data,IdCurso,IdAluno")] Matricula matricula)
        {
